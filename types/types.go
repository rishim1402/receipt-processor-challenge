...
type Item struct {
	...
	Price            string `json:"price" binding:"required,numeric" validate:"required,numeric,gte=0"`
}
...
type Receipt struct {
	...
	Total        string `json:"total" binding:"required,numeric" validate:"required,numeric,gte=0"`
}
